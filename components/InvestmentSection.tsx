...
export default function InvestmentSection({ lang }: InvestmentSectionProps) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-[color:var(--color-secondary)]/30  px-4 py-16 text-primary sm:px-5 md:px-8 md:py-20 xl:px-14 xl:py-24"
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-32  to-transparent md:h-40" />
