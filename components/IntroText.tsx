    ...
    >
      ...
      <div className="relative mx-auto flex max-w-md flex-col gap-8 md:max-w-3xl md:gap-10 xl:max-w-7xl xl:gap-14">
        <div className="space-y-5 md:space-y-6">
          ...
          <p className="max-w-2xl border-[color:var(--color-secondary)]/70 pl-4 text-sm leading-7 text-primary/78 md:pl-6 md:text-base xl:text-lg xl:leading-8">
            {content.body}
          </p>
        </div>

        <div className="grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] xl:items-start xl:gap-8">
          <div className="rounded-[1.75rem] border border-[color:var(--color-secondary)]/60 bg-white/94 p-5 shadow-[0_24px_80px_-48px_rgba(0,35,91,0.35)] backdrop-blur-sm sm:p-6 md:rounded-[2rem] md:p-8">
