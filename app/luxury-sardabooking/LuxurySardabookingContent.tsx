...
type LuxurySardabookingSection = {
    id: string;
    title: string;
    items: string[];
    note?: string;
...
type LuxurySardabookingPageContent = {
    backToHome: string;
    eyebrow: string;
    title: string;
    mission: string;
    ...
    focus: string;
    focusItems: string[];
    sections: LuxurySardabookingSection[];
};

const pageContent: Record<"it" | "en", LuxurySardabookingPageContent> = {
    it: itMessages.luxurySardabookingPage,
    en: enMessages.luxurySardabookingPage,
};

const divisionBackgroundImage = "/SectionsBackgrounds/LuxurySardabooking.png";
const sectionImages = [
    "/LuxurySardabooking/Luxury_Sardabooking_Villas.jpeg",
    "/LuxurySardabooking/Sardabooking_Hotel&Resort.png",
    "/LuxurySardabooking/Sardabooking_Experiences.jpeg",
    "/LuxurySardabooking/SardaBooking_Events.png",
    "/LuxurySardabooking/SardaBooking_Real_Estate.png",
    "/LuxurySardabooking/SardaBooking_Concierge.png",
    "/LuxurySardabooking/SardaBooking_Incoming&Travel.png",
    "/LuxurySardabooking/SardaBooking_Corporate.jpeg",
] as const;
                    ...
                    <div className="grid gap-5 xl:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] xl:items-stretch xl:gap-6">
                        <div className="relative overflow-hidden border border-[color:var(--color-primary)]/10 bg-white p-5 shadow-[0_28px_80px_rgba(31,39,92,0.08)] md:p-7 xl:p-8">
                            ...
                            <div className="relative flex h-full flex-col justify-center">
                                ...
                                <div className="mx-auto flex max-w-3xl flex-col items-start gap-4 text-left md:gap-5">
